...
* [AppImageLauncher](https://github.com/TheAssassin/AppImageLauncher) ⭐ 8,313 | 🐛 205 | 🌐 C++ | 📅 2026-03-09 - Integrates into users' systems and establishes a single `~/Applications` directory, assisting the user to move AppImages into there, with support for updating and removing AppImages through apps launcher.
* [Gear lever](https://github.com/mijorus/gearlever/) ⭐ 2,204 | 🐛 208 | 🌐 Python | 📅 2026-07-22 - Integrates AppImages into the Gnome desktop by drag-and-drop onto the Gear lever application.
...
* [AppImageUpdate](https://github.com/AppImage/AppImageUpdate) ⭐ 732 | 🐛 79 | 🌐 C++ | 📅 2025-10-18 - Official grapical application to update AppImages; command-line tool to update AppImages.
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,651 | 🐛 523 | 🌐 C | 📅 2026-09-16 - Optional sandbox with support for AppImage built in.
...
* [bauh](https://github.com/vinifmor/bauh) ⭐ 1,405 | 🐛 107 | 🌐 Python | 📅 2024-10-13 - Graphical user interface for managing Linux applications supporting AppImage, Arch (repositories/AUR), Flatpak, Snap and native Web applications.
...
* [AppMan](https://github.com/ivan-hc/AppMan) ⭐ 354 | 🐛 0 | 🌐 Shell | 📅 2026-09-13 - AppImage Manager that works like APT or Pacman.
...
* [appimagetool](https://github.com/AppImage/AppImageKit/releases/tag/continuous) ⭐ 9,425 | 🐛 236 | 📅 2026-07-26 - Converts AppDirs into AppImages.
...
* [electron-builder](https://github.com/electron-userland/electron-builder) ⭐ 14,662 | 🐛 89 | 🌐 TypeScript | 📅 2026-09-18 - Supports AppImage as an output format.
...
* [libappimage](https://github.com/AppImage/libappimage) ⭐ 57 | 🐛 61 | 🌐 C++ | 📅 2025-10-31 - Implements functionality for dealing with AppImage files, written in C++ using Boost.
...
* [AppImage wiki](https://github.com/AppImage/AppImageKit/wiki) ⭐ 9,425 | 🐛 236 | 📅 2026-07-26 - Official AppImage wiki.
...
* [Similar projects](https://github.com/AppImage/AppImageKit/wiki/Similar-projects) ⭐ 9,425 | 🐛 236 | 📅 2026-07-26 - Comparison to other packaging systems.
