...
* [AppImageLauncher](https://github.com/TheAssassin/AppImageLauncher) ⭐ 8,281 | 🐛 206 | 🌐 C++ | 📅 2026-03-09 - Integrates into users' systems and establishes a single `~/Applications` directory, assisting the user to move AppImages into there, with support for updating and removing AppImages through apps launcher.
* [Gear lever](https://github.com/mijorus/gearlever/) ⭐ 2,155 | 🐛 206 | 🌐 Python | 📅 2026-07-22 - Integrates AppImages into the Gnome desktop by drag-and-drop onto the Gear lever application.
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,621 | 🐛 522 | 🌐 C | 📅 2026-09-01 - Optional sandbox with support for AppImage built in.
...
* [AppMan](https://github.com/ivan-hc/AppMan) ⭐ 345 | 🐛 0 | 🌐 Shell | 📅 2026-08-30 - AppImage Manager that works like APT or Pacman.
...
* [linuxdeploy](https://github.com/linuxdeploy/linuxdeploy) ⭐ 817 | 🐛 102 | 🌐 C++ | 📅 2026-08-01 - AppDir creation and maintenance tool using plugins.
...
* [electron-builder](https://github.com/electron-userland/electron-builder) ⭐ 14,660 | 🐛 99 | 🌐 TypeScript | 📅 2026-09-02 - Supports AppImage as an output format.
