...
* [AppImagePool](https://github.com/prateekmedia/appimagepool) ⭐ 721 | 🐛 28 | 🌐 Dart | 📅 2026-03-12 - Simple, modern AppImageHub Client, powered by flutter.
...
* [AppImageLauncher](https://github.com/TheAssassin/AppImageLauncher) ⭐ 8,223 | 🐛 204 | 🌐 C++ | 📅 2026-03-09 - Integrates into users' systems and establishes a single `~/Applications` directory, assisting the user to move AppImages into there, with support for updating and removing AppImages through apps launcher.
* [Gear lever](https://github.com/mijorus/gearlever/) ⭐ 2,095 | 🐛 200 | 🌐 Python | 📅 2026-07-22 - Integrates AppImages into the Gnome desktop by drag-and-drop onto the Gear lever application.
* [go-appimaged](https://github.com/probonopd/go-appimage/tree/master/src/appimaged) ⭐ 1,165 | 🐛 134 | 🌐 Go | 📅 2026-06-07 - Optional daemon that integrates AppImages into the system (experimental).
...
* [AppImageUpdate](https://github.com/AppImage/AppImageUpdate) ⭐ 726 | 🐛 79 | 🌐 C++ | 📅 2025-10-18 - Official grapical application to update AppImages; command-line tool to update AppImages.
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,594 | 🐛 526 | 🌐 C | 📅 2026-08-07 - Optional sandbox with support for AppImage built in.
* [AppImage Sandboxing Project](https://github.com/mgord9518/aisap) ⭐ 63 | 🐛 2 | 🌐 Zig | 📅 2024-12-02 - Golang library to help sandbox AppImages with bwrap.
...
* [bauh](https://github.com/vinifmor/bauh) ⭐ 1,393 | 🐛 107 | 🌐 Python | 📅 2024-10-13 - Graphical user interface for managing Linux applications supporting AppImage, Arch (repositories/AUR), Flatpak, Snap and native Web applications.
* [Zap](https://github.com/srevinsaju/zap) ⭐ 594 | 🐛 51 | 🌐 Go | 📅 2024-06-14 - AppImage package manager. Downloads the AppImage if it does not exist. If it already exists, updates it with AppImageUpdate. Integrates AppImage into the system.
* [AppMan](https://github.com/ivan-hc/AppMan) ⭐ 335 | 🐛 0 | 🌐 Shell | 📅 2026-08-13 - AppImage Manager that works like APT or Pacman.
...
* [Linux Mint](https://linuxmint.com/) - Has an [AppImage thumbnailer](https://github.com/linuxmint/xapp-thumbnailers) ⭐ 57 | 🐛 5 | 🌐 Python | 📅 2026-06-16 to show application icons on AppImage files.
...
* [appimagetool](https://github.com/AppImage/AppImageKit/releases/tag/continuous) ⭐ 9,409 | 🐛 237 | 📅 2026-07-26 - Converts AppDirs into AppImages.
* [nix-bundle](https://github.com/matthewbauer/nix-bundle) ⭐ 853 | 🐛 58 | 🌐 Nix | 📅 2025-09-01 - Converts Nix derivations into AppImages.

### Build systems

* [appimage-builder](https://github.com/AppImageCrafters/appimage-builder) ⭐ 384 | 🐛 94 | 🌐 Python | 📅 2026-05-05 - Recipe based AppImage creation tool working from source.
* [appimagecraft](https://github.com/TheAssassin/appimagecraft) ⭐ 52 | 🐛 12 | 🌐 Python | 📅 2026-08-04 - Recipe based AppImage creation tool working from source.
* [rules\_appimage](https://github.com/lalten/rules_appimage) ⭐ 39 | 🐛 17 | 🌐 Starlark | 📅 2026-08-12 - Bazel rules to package any lang\_binary target as AppImage.
...
* [linuxdeployqt](https://github.com/probonopd/linuxdeployqt) ⭐ 2,467 | 🐛 212 | 🌐 C++ | 📅 2025-10-21 - Deploys dependencies into AppDirs and creates AppImages; for Qt and other compiled applications.
* [go-appimagetool](https://github.com/probonopd/go-appimage/tree/master/src/appimagetool) ⭐ 1,165 | 🐛 134 | 🌐 Go | 📅 2026-06-07 - Tool that deploys dependencies into AppDirs, and converts AppDirs into AppImages (experimental).
* [linuxdeploy](https://github.com/linuxdeploy/linuxdeploy) ⭐ 813 | 🐛 100 | 🌐 C++ | 📅 2026-08-01 - AppDir creation and maintenance tool using plugins.
...
* [python-appimage](https://github.com/niess/python-appimage) ⭐ 223 | 🐛 17 | 🌐 Python | 📅 2026-08-02 - Ready to use AppImage distributions of Python (can be modified to include your application).
* [linuxdeploy-plugin-conda](https://github.com/linuxdeploy/linuxdeploy-plugin-conda) ⭐ 31 | 🐛 19 | 🌐 Shell | 📅 2024-09-07 - Bundle Python into an AppDir using a source distribution, Conda, and linuxdeploy.
* [PyAppImage](https://github.com/srevinsaju/pyappimage) ⭐ 29 | 🐛 2 | 🌐 Python | 📅 2021-10-08 - Ultimately simple python-to-appimage bundler.
...
* [electron-builder](https://github.com/electron-userland/electron-builder) ⭐ 14,640 | 🐛 84 | 🌐 TypeScript | 📅 2026-08-12 - Supports AppImage as an output format.
...
* [AppImage For WINE](https://github.com/Hackerl/Wine_Appimage) ⭐ 478 | 🐛 12 | 🌐 Shell | 📅 2021-04-19 - WINE-based AppImages and LD\_PRELOAD based patches to launch WINE from AppImages.
* [wine32-deploy](https://github.com/sudo-give-me-coffee/wine32-deploy) ⭐ 62 | 🐛 8 | 🌐 Shell | 📅 2021-02-11 - Creates AppImages for 32-bit Windows applications that can run on 64-bit Linux systems without multilib installed.
...
* [nbPackager](https://github.com/trixon/nbPackager) ⭐ 10 | 🐛 1 | 🌐 Java | 📅 2026-07-26 - Packages NetBeans Platform Application with a JRE for AppImage, Linux, macOS and Windows.

### Deployment tools for .NET Core (Mono) applications

* [PupNet Deploy](https://github.com/kuiperzone/PupNet-Deploy) ⭐ 258 | 🐛 5 | 🌐 C# | 📅 2026-04-12 - Cross-platform deployment utility which publishes your .NET project and packages it as a ready-to-ship installation file in a single step.
* [DotnetPackaging](https://github.com/SuperJMN/DotnetPackaging) ⭐ 131 | 🐛 4 | 🌐 C# | 📅 2026-05-17 - Tool to distribute .NET applications in the AppImage format.
* [.NET Core AppImage example](https://github.com/ppy/osu-deploy/blob/697a49e9602502a2b7a899c0dff5383f6512d5d2/Program.cs#L207-L243) ⭐ 55 | 🐛 2 | 🌐 C# | 📅 2026-06-08 - Example of how to deploy .NET Core (Mono) applications as an AppImage using `dotnet publish -f netcoreapp3.1 -r linux-x64` from within a `.cs` program.
...
* [Cargo AppImage](https://github.com/StratusFearMe21/cargo-appimage) ⭐ 79 | 🐛 10 | 🌐 Rust | 📅 2025-08-09 - Cargo program that allows you to convert your Rust programs into AppImages.

### Tools to convert from other package formats

* [pkg2appimage](https://github.com/AppImage/pkg2appimage) ⭐ 792 | 🐛 184 | 🌐 Shell | 📅 2025-07-21 - Converts from deb, zip, tar.gz and other formats to AppImage using YAML recipes.
...
* [flatpak2appdir](https://github.com/sudo-give-me-coffee/flatpak2appdir) ⭐ 32 | 🐛 7 | 🌐 Shell | 📅 2020-05-11 - Turn Flatpak into AppDir which in turn can be turned into AppImage.
* [appimage-bash](https://github.com/valicm/appimage-bash) ⭐ 19 | 🐛 2 | 🌐 Shell | 📅 2025-01-16 - GitHub Action for creating AppImage releases from binaries inside `.tar.gz` archives.
...
* [GMAppImager](https://github.com/samuelvenable/GMAppImager) ⭐ 2 | 🐛 0 | 🌐 Game Maker Language | 📅 2026-06-13 - Graphically Converts GameMaker Studio 2 games to AppImage bundles.
...
* [appimagelint](https://github.com/TheAssassin/appimagelint) ⭐ 57 | 🐛 16 | 🌐 Python | 📅 2026-06-23 - Tool to check AppImages for compatibility, best practices etc.
...
* [appimage.yml](https://github.com/iotang/Project_LemonLime/blob/master/.github/workflows/appimage.yml) ⭐ 702 | 🐛 78 | 🌐 C++ | 📅 2026-07-22 - Bigger, more complex example of how to build and upload AppImages using GitHub Actions.
...
* [libappimage](https://github.com/AppImage/libappimage) ⭐ 57 | 🐛 60 | 🌐 C++ | 📅 2025-10-31 - Implements functionality for dealing with AppImage files, written in C++ using Boost.
* [QAppImageUpdate](https://github.com/antony-jr/QAppImageUpdate) ⭐ 28 | 🐛 1 | 🌐 C++ | 📅 2021-10-20 - Qt5 library and plugin for updating AppImages, can be embedded into applications.
...
* [appenv](https://github.com/TheMarlboroMan/appenv) ⭐ 0 | 🐛 0 | 🌐 C++ | 📅 2026-06-12 - Small C++ library telling where the app data resides and where the user data is by using `readlink("/proc/self/exe")`), thus allowing C++ applications to become relocatable in the filesystem.
...
* [Briefcase Linux AppImage Template](https://github.com/beeware/briefcase-linux-appimage-template) ⭐ 23 | 🐛 3 | 🌐 Dockerfile | 📅 2026-07-08 - Cookiecutter template for building Python apps that will run under Linux, packaged as an AppImage.
...
* [AppImageSpec](https://github.com/AppImage/AppImageSpec) ⭐ 93 | 🐛 30 | 📅 2026-04-03 - Official specification for the AppImage format.
...
* [AppImage wiki](https://github.com/AppImage/AppImageKit/wiki) ⭐ 9,409 | 🐛 237 | 📅 2026-07-26 - Official AppImage wiki.
...
* [Similar projects](https://github.com/AppImage/AppImageKit/wiki/Similar-projects) ⭐ 9,409 | 🐛 237 | 📅 2026-07-26 - Comparison to other packaging systems.
...
* [AppImage-Integrator](https://github.com/w-j-r/AppImage-Integrator) ⭐ 5 | 🐛 0 | 🌐 C++ | 📅 2022-12-10 - A simple program to integrate AppImages into the Linux desktop written in Qt6.
