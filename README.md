...
* [Gear lever](https://github.com/mijorus/gearlever/) ⭐ 2,168 | 🐛 207 | 🌐 Python | 📅 2026-07-22 - Integrates AppImages into the Gnome desktop by drag-and-drop onto the Gear lever application.
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,632 | 🐛 524 | 🌐 C | 📅 2026-09-07 - Optional sandbox with support for AppImage built in.
...
* [AppMan](https://github.com/ivan-hc/AppMan) ⭐ 348 | 🐛 0 | 🌐 Shell | 📅 2026-09-06 - AppImage Manager that works like APT or Pacman.
...
* [rules\_appimage](https://github.com/lalten/rules_appimage) ⭐ 39 | 🐛 17 | 🌐 Starlark | 📅 2026-09-07 - Bazel rules to package any lang\_binary target as AppImage.
...
* [electron-builder](https://github.com/electron-userland/electron-builder) ⭐ 14,659 | 🐛 104 | 🌐 TypeScript | 📅 2026-09-08 - Supports AppImage as an output format.
