...
* [Gear lever](https://github.com/mijorus/gearlever/) ⭐ 2,225 | 🐛 212 | 🌐 Python | 📅 2026-07-22 - Integrates AppImages into the Gnome desktop by drag-and-drop onto the Gear lever application.
* [go-appimaged](https://github.com/probonopd/go-appimage/tree/master/src/appimaged) ⭐ 1,177 | 🐛 137 | 🌐 Go | 📅 2026-09-03 - Optional daemon that integrates AppImages into the system (experimental).
...
* [AppMan](https://github.com/ivan-hc/AppMan) ⭐ 355 | 🐛 0 | 🌐 Shell | 📅 2026-09-24 - AppImage Manager that works like APT or Pacman.
...
* [go-appimagetool](https://github.com/probonopd/go-appimage/tree/master/src/appimagetool) ⭐ 1,177 | 🐛 137 | 🌐 Go | 📅 2026-09-03 - Tool that deploys dependencies into AppDirs, and converts AppDirs into AppImages (experimental).
...
* [electron-builder](https://github.com/electron-userland/electron-builder) ⭐ 14,669 | 🐛 73 | 🌐 TypeScript | 📅 2026-09-26 - Supports AppImage as an output format.
