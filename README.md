...
* [AppImageLauncher](https://github.com/TheAssassin/AppImageLauncher) ⭐ 8,231 | 🐛 204 | 🌐 C++ | 📅 2026-03-09 - Integrates into users' systems and establishes a single `~/Applications` directory, assisting the user to move AppImages into there, with support for updating and removing AppImages through apps launcher.
* [Gear lever](https://github.com/mijorus/gearlever/) ⭐ 2,100 | 🐛 200 | 🌐 Python | 📅 2026-07-22 - Integrates AppImages into the Gnome desktop by drag-and-drop onto the Gear lever application.
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,597 | 🐛 526 | 🌐 C | 📅 2026-08-15 - Optional sandbox with support for AppImage built in.
...
* [Zap](https://github.com/srevinsaju/zap) ⭐ 596 | 🐛 51 | 🌐 Go | 📅 2024-06-14 - AppImage package manager. Downloads the AppImage if it does not exist. If it already exists, updates it with AppImageUpdate. Integrates AppImage into the system.
* [AppMan](https://github.com/ivan-hc/AppMan) ⭐ 338 | 🐛 0 | 🌐 Shell | 📅 2026-08-16 - AppImage Manager that works like APT or Pacman.
...
* [appimagetool](https://github.com/AppImage/AppImageKit/releases/tag/continuous) ⭐ 9,411 | 🐛 237 | 📅 2026-07-26 - Converts AppDirs into AppImages.
...
* [appimagecraft](https://github.com/TheAssassin/appimagecraft) ⭐ 53 | 🐛 12 | 🌐 Python | 📅 2026-08-04 - Recipe based AppImage creation tool working from source.
...
* [electron-builder](https://github.com/electron-userland/electron-builder) ⭐ 14,640 | 🐛 84 | 🌐 TypeScript | 📅 2026-08-15 - Supports AppImage as an output format.
...
* [appimage.yml](https://github.com/iotang/Project_LemonLime/blob/master/.github/workflows/appimage.yml) ⭐ 704 | 🐛 80 | 🌐 C++ | 📅 2026-07-22 - Bigger, more complex example of how to build and upload AppImages using GitHub Actions.
...
* [AppImage wiki](https://github.com/AppImage/AppImageKit/wiki) ⭐ 9,411 | 🐛 237 | 📅 2026-07-26 - Official AppImage wiki.
...
* [Similar projects](https://github.com/AppImage/AppImageKit/wiki/Similar-projects) ⭐ 9,411 | 🐛 237 | 📅 2026-07-26 - Comparison to other packaging systems.
