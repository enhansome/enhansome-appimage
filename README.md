...
* [AppImageLauncher](https://github.com/TheAssassin/AppImageLauncher) ⭐ 8,291 | 🐛 205 | 🌐 C++ | 📅 2026-03-09 - Integrates into users' systems and establishes a single `~/Applications` directory, assisting the user to move AppImages into there, with support for updating and removing AppImages through apps launcher.
* [Gear lever](https://github.com/mijorus/gearlever/) ⭐ 2,177 | 🐛 208 | 🌐 Python | 📅 2026-07-22 - Integrates AppImages into the Gnome desktop by drag-and-drop onto the Gear lever application.
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,645 | 🐛 523 | 🌐 C | 📅 2026-09-11 - Optional sandbox with support for AppImage built in.
...
* [bauh](https://github.com/vinifmor/bauh) ⭐ 1,404 | 🐛 107 | 🌐 Python | 📅 2024-10-13 - Graphical user interface for managing Linux applications supporting AppImage, Arch (repositories/AUR), Flatpak, Snap and native Web applications.
...
* [AppMan](https://github.com/ivan-hc/AppMan) ⭐ 350 | 🐛 0 | 🌐 Shell | 📅 2026-09-06 - AppImage Manager that works like APT or Pacman.
...
* [nix-bundle](https://github.com/matthewbauer/nix-bundle) ⭐ 860 | 🐛 58 | 🌐 Nix | 📅 2025-09-01 - Converts Nix derivations into AppImages.
...
* [rules\_appimage](https://github.com/lalten/rules_appimage) ⭐ 39 | 🐛 17 | 🌐 Starlark | 📅 2026-09-10 - Bazel rules to package any lang\_binary target as AppImage.
...
* [linuxdeploy](https://github.com/linuxdeploy/linuxdeploy) ⭐ 820 | 🐛 101 | 🌐 C++ | 📅 2026-08-01 - AppDir creation and maintenance tool using plugins.
...
* [electron-builder](https://github.com/electron-userland/electron-builder) ⭐ 14,660 | 🐛 95 | 🌐 TypeScript | 📅 2026-09-11 - Supports AppImage as an output format.
...
* [appimage.yml](https://github.com/iotang/Project_LemonLime/blob/master/.github/workflows/appimage.yml) ⭐ 705 | 🐛 79 | 🌐 C++ | 📅 2026-07-22 - Bigger, more complex example of how to build and upload AppImages using GitHub Actions.
