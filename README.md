...
* [Gear lever](https://github.com/mijorus/gearlever/) ⭐ 2,177 | 🐛 207 | 🌐 Python | 📅 2026-07-22 - Integrates AppImages into the Gnome desktop by drag-and-drop onto the Gear lever application.
...
* [Firejail](https://github.com/netblue30/firejail) ⭐ 7,642 | 🐛 523 | 🌐 C | 📅 2026-09-11 - Optional sandbox with support for AppImage built in.
...
* [AppMan](https://github.com/ivan-hc/AppMan) ⭐ 349 | 🐛 0 | 🌐 Shell | 📅 2026-09-06 - AppImage Manager that works like APT or Pacman.
...
* [electron-builder](https://github.com/electron-userland/electron-builder) ⭐ 14,660 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-11 - Supports AppImage as an output format.
